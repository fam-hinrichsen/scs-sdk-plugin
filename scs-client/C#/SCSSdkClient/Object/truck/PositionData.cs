...
namespace SCSSdkClient.Object.truck {
    /// <summary>
    ...
    public class PositionData {
        ...
        /// </summary>
        public FVector HeadPositionInCabinSpace => SCSTelemetry.Add(Head, HeadOffset.Position);
        ...
        public FVector HeadPositionInVehicleSpace =>
            SCSTelemetry.Add(SCSTelemetry.Add(Cabin, CabinOffset.Position), SCSTelemetry.Rotate(CabinOffset.Orientation, HeadPositionInCabinSpace));
        /// <summary>
        ///     Head position in the World Space. Head is the Player models (viewable e.g. in camera perspective 2) head.
        /// </summary>
        public DVector HeadPositionInWorldSpace => SCSTelemetry.Add(TruckPosition.Position,
                                                        SCSTelemetry.Rotate(TruckPosition.Orientation,
        ...
        public DVector CabinPositionInWorlSpace =>
            SCSTelemetry.Add(TruckPosition.Position, SCSTelemetry.Rotate(TruckPosition.Orientation, Cabin));
        ...
        public DVector HookPositionInWorldSpace =>
            SCSTelemetry.Add(TruckPosition.Position, SCSTelemetry.Rotate(TruckPosition.Orientation, Hook));
    }
}